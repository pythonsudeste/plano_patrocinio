...
\author{pythonsul@gmail.com \\ Adriano Margarin (054 ????? ????)}
\date{\today}
%%%%%%%%%%%%%%%
...
\begin{itemize}[label={}]
    \item \emph{PythonSul} (oficial do evento) : x seguidores
    \item \emph{PythonFloripa} : x seguidores
    \item \emph{PyTchê } : x seguidores
\end{itemize}
...
Hoje, temos mais de 100 projetos open source mantidos por pythonistas dos 4 estados do Sul, centenas de empresas utilizando Python com diferentes objetivos como: Análise de dados, Desenvolvimento de aplicações Web, Internet das Coisas, etc.
...
$^2$ O post do patrocinador será feito pela página do facebook e do twitter nas contas na Python Sul e Python Rio. Na página do facebook será feito um post promovido aumentando o alcance.
